...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" href="CSS/CR_historique.css">
    </head>
    <body onload="menu(2)">
    <?php include($_SERVER['DOCUMENT_ROOT'] .'/Arcadia.html'); ?>
        ...
        <h2 class="bgelt"> Historique des CR </h2>
        <section class="bgelt">
            <article>
        ...
        <section id="lstCR">
            <?php include("PHP/Vue/detail_CR_Vet.php"); ?>
        </section>
    ...
    <script src="JS/CR_historique.js"></script>
    </body>
</html>
